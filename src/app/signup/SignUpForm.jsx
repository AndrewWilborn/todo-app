    ...
    return (
        <section className="bg-emerald-200 text-violet-950 p-6 rounded-lg max-w-[420px] w-full mx-auto">
            <form onSubmit={handleSignup} className="flex flex-col items-start justify-around min-h-[30vh]">
                ...
                <input type="submit" value="Sign Up"  className="bg-violet-500 text-orange-50 py-2 px-8 rounded-lg shadow-lg transition duration-300 hover:bg-violet-700 hover:shadow-sm cursor-pointer w-full"/>
            </form>
            <button onClick={handleGoogle}className="mt-4 bg-sky-500 text-orange-50 py-2 px-8 rounded-lg shadow-lg transition duration-300 hover:bg-sky-700 hover:shadow-sm cursor-pointer w-full">Sign Up With Google</button>
        </section>
